...
@section('main')
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class=" pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2 mb-4">Tambah Pegawai</h1>
        ...
        <form action="{{ route('simpan_pegawai') }}" method="POST">
          ...
          <div class="row g-3">
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="nip" name="nip" value="{{ old('nip') }}" placeholder="NIP">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Pegawai" value="{{ old('nama') }}">
              <span class="text-danger">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="pangkat_gol" name="pangkat_gol" placeholder="Pangkat/Gol" value="{{ old('pangkat_gol') }}">
              <span class="text-danger">
            ...
            <div class="col-sm-4">
              ...
              <input type="date" class="form-control" id="tmt_capeg" name="tmt_capeg" placeholder="Tmt Capeg" value="{{ old('tmt_capeg') }}">
              <span class="text-danger">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="pangkat" name="pangkat" placeholder="Pangkat Terakhir" value="{{ old('pangkat') }}">
              <span class="text-danger">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="riwayat" name="riwayat" placeholder="Riwayat Pekerjaan" value="{{ old('riwayat') }}">
              <span class="text-danger">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="penghargaan" name="penghargaan" placeholder="Riwayat Penghargaan" value="{{ old('penghargaan') }}">
              <span class="text-danger">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="npwp" name="npwp" placeholder="No. NPWP" value="{{ old('npwp') }}">
              <span class="text-danger">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="No. Telephon" value="{{ old('no_telp') }}">
              <span class="text-danger">
